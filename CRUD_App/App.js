...
constructor(props) {
   ...
   this.state = {
     ...
     TextInput_Student_Acadamic_Year: '',
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('https://localhost:19006/php/InsertStudentData.php', {
      method: 'POST',
      headers: {
      ...
      body: JSON.stringify({
        ...
        student_acadamic_year : this.state.TextInput_Student_Acadamic_Year,
...
<View style={styles.MainContainer}>
      ...
      <TextInput
         ...
         placeholder="Enter Student Acadamic Year"

         onChangeText={ TextInputValue => this.setState({ TextInput_Student_Acadamic_Year : TextInputValue }) }
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('https://localhost:19006/php/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
     ...
     GetStudentIDFunction=(student_id,student_name, student_acadamic_year, student_phone_number, student_email)=>{

          this.props.navigation.navigate('Third', { 

            ID : student_id,
            NAME : student_name,
            ACADAMIC_YEAR : student_acadamic_year,
  ...
  constructor(props) {
     ...
     componentDidMount(){
      ...
      this.setState({ 
        ...
        TextInput_Student_Acadamic_Year: this.props.navigation.state.params.ACADAMIC_YEAR,
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('https://localhost:19006/php/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('https://localhost:19006/php/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
   ...
   <View style={styles.MainContainer}>
         ...
         <TextInput
            ...
            value={this.state.TextInput_Student_Acadamic_Year}
