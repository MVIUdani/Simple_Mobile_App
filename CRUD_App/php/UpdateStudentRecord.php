...
// Connecting to MySQL Database.
 $con = mysqli_connect($HostName,$HostUser,$HostPass,$DatabaseName,$HostPort);
 ...
 // Populate Student Acadamic Year from JSON $obj array and store into $S_Class.
 $S_AcaYear = $obj['student_acadamic_year'];
 ...
 $Sql_Query = "UPDATE StudentDetailsTable SET student_name= '$S_Name', student_acadamic_year = '$S_AcaYear', student_phone_number = '$S_Phone_Number', student_email = '$S_Email' WHERE student_id = $S_ID";
